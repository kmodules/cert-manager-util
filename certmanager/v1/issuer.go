...
func PatchIssuer(ctx context.Context, c cs.CertmanagerV1Interface, cur *api.Issuer, transform func(*api.Issuer) *api.Issuer, opts metav1.PatchOptions) (*api.Issuer, kutil.VerbType, error) {
	return PatchIssuerObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchIssuerObject(ctx context.Context, c cs.CertmanagerV1Interface, cur, mod *api.Issuer, opts metav1.PatchOptions) (*api.Issuer, kutil.VerbType, error) {
