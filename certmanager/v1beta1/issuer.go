...
func CreateOrPatchIssuer(ctx context.Context, c cs.CertmanagerV1beta1Interface, meta metav1.ObjectMeta, transform func(alert *api.Issuer) *api.Issuer, opts metav1.PatchOptions) (*api.Issuer, kutil.VerbType, error) {
...
func PatchIssuer(ctx context.Context, c cs.CertmanagerV1beta1Interface, cur *api.Issuer, transform func(*api.Issuer) *api.Issuer, opts metav1.PatchOptions) (*api.Issuer, kutil.VerbType, error) {
	return PatchIssuerObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchIssuerObject(ctx context.Context, c cs.CertmanagerV1beta1Interface, cur, mod *api.Issuer, opts metav1.PatchOptions) (*api.Issuer, kutil.VerbType, error) {
...
func TryUpdateIssuer(ctx context.Context, c cs.CertmanagerV1beta1Interface, meta metav1.ObjectMeta, transform func(*api.Issuer) *api.Issuer, opts metav1.UpdateOptions) (result *api.Issuer, err error) {
	attempt := 0
