...
func CreateOrPatchCertificateRequest(ctx context.Context, c cs.CertmanagerV1beta1Interface, meta metav1.ObjectMeta, transform func(alert *api.CertificateRequest) *api.CertificateRequest, opts metav1.PatchOptions) (*api.CertificateRequest, kutil.VerbType, error) {
...
func PatchCertificateRequest(ctx context.Context, c cs.CertmanagerV1beta1Interface, cur *api.CertificateRequest, transform func(*api.CertificateRequest) *api.CertificateRequest, opts metav1.PatchOptions) (*api.CertificateRequest, kutil.VerbType, error) {
	return PatchCertificateRequestObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchCertificateRequestObject(ctx context.Context, c cs.CertmanagerV1beta1Interface, cur, mod *api.CertificateRequest, opts metav1.PatchOptions) (*api.CertificateRequest, kutil.VerbType, error) {
...
func TryUpdateCertificateRequest(ctx context.Context, c cs.CertmanagerV1beta1Interface, meta metav1.ObjectMeta, transform func(*api.CertificateRequest) *api.CertificateRequest, opts metav1.UpdateOptions) (result *api.CertificateRequest, err error) {
	attempt := 0
...
func UpdateCertificateRequestStatus(
	ctx context.Context,
	c cs.CertmanagerV1beta1Interface,
