...
func PatchClusterIssuer(ctx context.Context, c cs.CertmanagerV1beta1Interface, cur *api.ClusterIssuer, transform func(*api.ClusterIssuer) *api.ClusterIssuer, opts metav1.PatchOptions) (*api.ClusterIssuer, kutil.VerbType, error) {
	return PatchClusterIssuerObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchClusterIssuerObject(ctx context.Context, c cs.CertmanagerV1beta1Interface, cur, mod *api.ClusterIssuer, opts metav1.PatchOptions) (*api.ClusterIssuer, kutil.VerbType, error) {
...
func TryUpdateClusterIssuer(ctx context.Context, c cs.CertmanagerV1beta1Interface, meta metav1.ObjectMeta, transform func(*api.ClusterIssuer) *api.ClusterIssuer, opts metav1.UpdateOptions) (result *api.ClusterIssuer, err error) {
	attempt := 0
