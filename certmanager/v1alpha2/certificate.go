...
func CreateOrPatchCertificate(ctx context.Context, c cs.CertmanagerV1alpha2Interface, meta metav1.ObjectMeta, transform func(alert *api.Certificate) *api.Certificate, opts metav1.PatchOptions) (*api.Certificate, kutil.VerbType, error) {
...
func PatchCertificate(ctx context.Context, c cs.CertmanagerV1alpha2Interface, cur *api.Certificate, transform func(*api.Certificate) *api.Certificate, opts metav1.PatchOptions) (*api.Certificate, kutil.VerbType, error) {
	return PatchCertificateObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchCertificateObject(ctx context.Context, c cs.CertmanagerV1alpha2Interface, cur, mod *api.Certificate, opts metav1.PatchOptions) (*api.Certificate, kutil.VerbType, error) {
...
func TryUpdateCertificate(ctx context.Context, c cs.CertmanagerV1alpha2Interface, meta metav1.ObjectMeta, transform func(*api.Certificate) *api.Certificate, opts metav1.UpdateOptions) (result *api.Certificate, err error) {
	attempt := 0
