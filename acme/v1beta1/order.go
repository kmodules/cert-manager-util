...
func PatchOrder(ctx context.Context, c cs.AcmeV1beta1Interface, cur *api.Order, transform func(*api.Order) *api.Order, opts metav1.PatchOptions) (*api.Order, kutil.VerbType, error) {
	return PatchOrderObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchOrderObject(ctx context.Context, c cs.AcmeV1beta1Interface, cur, mod *api.Order, opts metav1.PatchOptions) (*api.Order, kutil.VerbType, error) {
...
func TryUpdateOrder(ctx context.Context, c cs.AcmeV1beta1Interface, meta metav1.ObjectMeta, transform func(*api.Order) *api.Order, opts metav1.UpdateOptions) (result *api.Order, err error) {
	attempt := 0
