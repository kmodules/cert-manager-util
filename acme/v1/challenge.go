...
import (
	...
	api "github.com/cert-manager/cert-manager/pkg/apis/acme/v1"
	cs "github.com/cert-manager/cert-manager/pkg/client/clientset/versioned/typed/acme/v1"
...
func CreateOrPatchChallenge(ctx context.Context, c cs.AcmeV1Interface, meta metav1.ObjectMeta, transform func(alert *api.Challenge) *api.Challenge, opts metav1.PatchOptions) (*api.Challenge, kutil.VerbType, error) {
...
func PatchChallenge(ctx context.Context, c cs.AcmeV1Interface, cur *api.Challenge, transform func(*api.Challenge) *api.Challenge, opts metav1.PatchOptions) (*api.Challenge, kutil.VerbType, error) {
	return PatchChallengeObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchChallengeObject(ctx context.Context, c cs.AcmeV1Interface, cur, mod *api.Challenge, opts metav1.PatchOptions) (*api.Challenge, kutil.VerbType, error) {
