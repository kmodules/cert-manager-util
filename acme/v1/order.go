...
func CreateOrPatchOrder(ctx context.Context, c cs.AcmeV1Interface, meta metav1.ObjectMeta, transform func(alert *api.Order) *api.Order, opts metav1.PatchOptions) (*api.Order, kutil.VerbType, error) {
...
func PatchOrder(ctx context.Context, c cs.AcmeV1Interface, cur *api.Order, transform func(*api.Order) *api.Order, opts metav1.PatchOptions) (*api.Order, kutil.VerbType, error) {
	return PatchOrderObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchOrderObject(ctx context.Context, c cs.AcmeV1Interface, cur, mod *api.Order, opts metav1.PatchOptions) (*api.Order, kutil.VerbType, error) {
